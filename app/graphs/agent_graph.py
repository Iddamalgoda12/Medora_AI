...
from app.nodes.rag_node import (
    rag_generate_node,
    rag_format_node,
    rag_retrieve_node,
)
...
def build_graph():
    ...
    route_decision
      ↓
    agent OR rag_retrieve -> rag_format -> rag_generate
      ↓
    ...
    builder.add_node("rag_format", rag_format_node)
    ...
    builder.add_edge("rag_retrieve", "rag_format")
    builder.add_edge("rag_format", "rag_generate")
